  ...
  const categories = [
    {
      ...
      image: "https://i.imgur.com/akDPQDH.png"
    },
    {
      ...
      image: "https://i.imgur.com/MnijZLY.png"
    },
    {
    ...
    },
    {
      ...
      image: "https://i.imgur.com/Dycf74P.png"
    }
  ];
    ...
    <section id="maquinas" className="py-24 bg-slate-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-16">
          <h2 className="text-4xl font-black text-slate-900 mb-4 uppercase">Alta Performance</h2>
          <p className="text-xl text-gray-600 border-l-8 border-amaral-yellow pl-6">
            Dispomos de uma frota moderna e diversificada para atender grandes demandas industriais e de infraestrutura.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {categories.map((cat, idx) => (
            <div key={idx} className="bg-white flex flex-col md:flex-row rounded-lg overflow-hidden shadow-sm hover:shadow-2xl transition-all border border-gray-100 group">
              ...
              <div className="md:w-3/5 p-8 flex flex-col justify-center">
                <h4 className="text-2xl font-black text-slate-900 mb-1 uppercase tracking-tight">{cat.title}</h4>
                <p className="text-amaral-yellow text-xs font-bold uppercase mb-4 tracking-widest">{cat.specs}</p>
